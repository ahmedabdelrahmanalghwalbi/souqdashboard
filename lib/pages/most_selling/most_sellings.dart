...
class MostSelling extends StatefulWidget {
  @override
  _MostSellingState createState() => _MostSellingState();
}
...
class _MostSellingState extends State<MostSelling> {
  ...
  createProduct()async{
    ...
    await FirebaseFirestore.instance.collection("MostSellingProducts").add({
      'name':productName,
            ...
            children: [
              Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection("MostSellingProducts").snapshots(),
